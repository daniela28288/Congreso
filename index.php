...
<body>
    ...
    <div class="container-lineas-tematicas">
        ...
        <h4>¿Hacia que áreas de investigación específicas está encaminado?</h4>
        <div class="tematicas">
            <div class="tematica">
    ...
    <div class="container-fondo-expositores">
        <img id="primer-expositor" src="img/nombres de exponentes_Mesa de trabajo 1.png" alt="">
    ...
    <div class="container-patrocinadores">
        <div class="apoya">
            <h3>Apoya</h3>
            <img src="img/log inca-01.png" alt="">
        </div>
        <div class="organiza">
            <h3>Organiza</h3>
            <img src="img/logo_sennova y sena.png" alt="">
        </div>
    </div>
    <footer>
