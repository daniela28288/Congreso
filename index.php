...
<body>
    ...
    <div class="banner">
        ...
        <!-- <div class="contenido">
            ...
            <p class="info_con">
                Conferencias magistrales nacionales e internacionales, <br>
                ponencias científicas, evento certificado y <br>
                feria de muestra comercial y empresarial del sector productivo.
            </p>
            <div class="fecha">
                <img src="img/icono de fecha.svg" alt="">
                <p>18 y 19 de Nov 2024</p>
            </div>
            <div class="ubi">
                <img src="img/icono lugar.svg" alt="">
    ...
    <div class="container-ultimo-banner">
        <h1>Teatro Akuaipia</h1>
        <p>Centro de Desarrollo Educativo Comfaguajira</p>
        <h3>Riohacha, La Guajira</h3>
    </div>
    ...
    <div class="seccion-patrocinadores">
        <div class="patrocinadores">
            ...
            <div class="logos">
                ...
                <a href="https://revistas.sena.edu.co/index.php/rnt/issue/archive" target="_blank"><img id="logo-revista" src="img/WhatsApp Image 2024-10-24 at 4.45.41 PM.jpeg" alt="Logo Patrocinador"></a>
            </div>
        </div>
        ...
        <div class="organiza">
            <h2>Organiza</h2>
            <div class="logos">
                <img id="logo-sennova" src="img/logo_sennova y sena.png" alt="Logo Sennova y Sena" class="logo-grande">
            </div>
        </div>
    </div>
